...
dirname = '/home/cburns/src/nipy-sf/niftypipe/trunk/'
...
def setup_paths():
    ...
    # Add our local path, where we install niftypipe, to sys.path
    sys.path.insert(0, pkg_path)
    # Needed to add this to my path at one point otherwise import of
    # apigen failed.
    # sys.path.insert(2, '/home/cburns/src/nipy-sf/niftypipe/trunk/tools')
