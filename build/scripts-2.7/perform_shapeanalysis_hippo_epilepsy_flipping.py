...
from niftypipe.workflows.shapeanalysis.shape_symmetrical_analysis import create_preprocessing_shape_analysis_epilepsy_flipping
...
def main():
    ...
    print labels
    # Create the workflow
    workflow = create_preprocessing_shape_analysis_epilepsy_flipping(labels=labels,
