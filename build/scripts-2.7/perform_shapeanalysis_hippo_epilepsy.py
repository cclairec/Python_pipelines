...
from niftypipe.workflows.shapeanalysis.shape_symmetrical_analysis import create_preprocessing_shape_analysis_epilepsy
...
def main():
    ...
    print labels
    # Create the workflow
    workflow = create_preprocessing_shape_analysis_epilepsy(labels=labels,
