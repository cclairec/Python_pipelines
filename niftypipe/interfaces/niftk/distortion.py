...
import math
import os
from nipype.interfaces.base import (TraitedSpec, File, traits, OutputMultiPath, BaseInterface, BaseInterfaceInputSpec)
...
class DistortionGenerator(BaseInterface):
    ...
    def _list_outputs(self):
        ...
        out_aff_filenames, out_bval_filenames, out_bvec_filenames = self._gen_output_filenames(self.inputs.bval_file,
...
class GradwarpCorrectionInputSpec(FSLCommandInputSpec):
    ...
    throughplaneonly = traits.Bool(argstr='-throughplaneonly', desc='Do through plane only correction.')
    inplaneonly = traits.Bool(argstr='-inplaneonly', desc='Do in plane only correction.')
...
class GradwarpCorrection(FSLCommand):
