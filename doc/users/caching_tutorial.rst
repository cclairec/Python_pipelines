...
:mod:`niftypipe.caching` module.

.. currentmodule:: niftypipe.caching
...
This is why niftypipe exposes an intermediate mechanism, `caching` that
...
niftypipe caching relies on the :class:`Memory` class: it creates an
execution context that is bound to a disk cache::

    >>> from niftypipe.caching import Memory
    >>> mem = Memory(base_dir='.')

Note that the caching directory is a subdirectory called `niftypipe_mem` of
the given `base_dir`. This is done to avoid polluting the base director.

In the corresponding execution context, niftypipe interfaces can be turned
...
command on a set of files::
    ...
    >>> from niftypipe.interface import fsl
...
the argument list by using the `fsl_merge?` synthax to inspect the docs::
    ...
    In [10]: fsl_merge?
    String Form:PipeFunc(niftypipe.interfaces.fsl.utils.Merge, base_dir=/home/varoquau/dev/niftypipe/niftypipe/caching/niftypipe_mem)
    Namespace:  Interactive
    File:       /home/varoquau/dev/niftypipe/niftypipe/caching/memory.py
...
Thus `fsl_merge` is applied to parameters as such::
    ...
    INFO:workflow:Executing node faa7888f5955c961e5c6aa70cbd5c807 in dir: /home/varoquau/dev/niftypipe/niftypipe/caching/niftypipe_mem/niftypipe-interfaces-fsl-utils-Merge/faa7888f5955c961e5c6aa70cbd5c807
    INFO:workflow:Running: fslmerge -t /home/varoquau/dev/niftypipe/niftypipe/caching/niftypipe_mem/niftypipe-interfaces-fsl-utils-Merge/faa7888f5955c961e5c6aa70cbd5c807/a_merged.nii /home/varoquau/dev/niftypipe/niftypipe/caching/a.nii.gz /home/varoquau/dev/niftypipe/niftypipe/caching/b.nii.gz

The results are standard niftypipe nodes results. In particular, they expose
an `outputs` attribute that carries all the outputs of the process, as
specified by the docs.

    >>> results.outputs.merged_file
    '/home/varoquau/dev/niftypipe/niftypipe/caching/niftypipe_mem/niftypipe-interfaces-fsl-utils-Merge/faa7888f5955c961e5c6aa70cbd5c807/a_merged.nii'
...
.. topic:: Debuging
    ...
    be useful to know where they were executed. With `niftypipe.caching`,
...
The main class of the :mod:`niftypipe.caching` module is the :class:`Memory`
class:
...
.. currentmodule:: niftypipe.caching.memory
