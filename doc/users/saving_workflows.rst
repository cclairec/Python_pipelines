...
(see `pickle <http://docs.python.org/2/library/pickle.html>`_) NiftyPipe
...
.. testcode::
	...
	from niftypipe.interfaces.fsl import BET, ImageMaths
	from niftypipe.pipeline.engine import Workflow, Node, MapNode, format_node
	from niftypipe.interfaces.utility import Function, IdentityInterface
...
.. testcode::
	...
	from niftypipe.pipeline.engine import Workflow, Node, MapNode
	from niftypipe.interfaces.utility import IdentityInterface
	from niftypipe.interfaces.utility import Function
	from niftypipe.utils.misc import getsource
	from niftypipe.interfaces.fsl.preprocess import BET
	from niftypipe.interfaces.fsl.utils import ImageMaths
	# Functions
	func = lambda x: x
	# Workflow
