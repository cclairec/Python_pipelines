...
The niftypipe interface modules provide a Python interface to external
...
the fsl module, the class :class:`niftypipe.interfaces.fsl.Bet` wraps the
``bet`` command-line tool.  Using the command-line tool, one would
specify options using flags like ``-o``, ``-m``, ``-f <f>``, etc...
However, in niftypipe, options are assigned to Python attributes and can
...
.. testcode::
   ...
   import niftypipe.interfaces.fsl as fsl
...
.. sourcecode:: ipython
    ...
    String Form:	<class 'niftypipe.interfaces.fsl.preprocess.FAST'>
    Namespace:	Interactive
    File:		/Users/satra/sp/niftypipe/interfaces/fsl/preprocess.py
    Docstring:
        ...
        >>> from niftypipe.testing import anatfile
...
.. sourcecode:: ipython
   ...
   Type:		type
   Base Class:	<type 'type'>
   String Form:	<class 'niftypipe.interfaces.spm.preprocess.Realign'>
   Namespace:	Interactive
   File:		/Users/satra/sp/niftypipe/interfaces/spm/preprocess.py
   Docstring:
       ...
       >>> import niftypipe.interfaces.spm as spm
       >>> realign = spm.Realign()
...
All of the niftypipe.interfaces classes have an ``help`` method
...
documentation. For instance, the :class:`niftypipe.interfaces.fsl.Bet`
