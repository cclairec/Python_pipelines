...
lightweight virtual environments. The NiftyPipe_ source now contains a Vagrantfile
...
latest NiftyPipe source and unzip/tar/compress it. Go into your terminal and switch
to the niftypipe source directory. Make sure the Vagrantfile is in the directory.
Now you can execute::
