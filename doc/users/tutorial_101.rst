...
other. In the context of niftypipe, every interface can be treated as a pipeline
...
data flow. The following niftypipe component architecture might help understanding
...
.. testcode::
   ...
   import niftypipe.interfaces.spm as spm         # the spm interfaces
   import niftypipe.pipeline.engine as pe         # the workflow and node wrappers
...
:class:`niftypipe.interfaces.spm.Realign`
...
.. testcode::
   ...
   import niftypipe.algorithms.rapidart as ra
