...
NiftyPipe 0.9 introduces a new interface for intelligently finding files on the
disk and feeding them into your workflows: :ref:`SelectFiles
<niftypipe.interfaces.io.SelectFiles>`. SelectFiles is intended as a simpler
alternative to the :ref:`DataGrabber <niftypipe.intefaces.io.DataGrabber>`
...
is quite straightforward::
    ...
    from niftypipe import SelectFiles
