...
==========================
Debugging NiftyPipe Workflows
==========================

Throughout NiftyPipe_ we try to provide meaningful error messages. If you run into
...
#. Use the debug config mode. This can be done by setting::
   ...
   as the first import of your niftypipe script.
...
#. All NiftyPipe crashfiles can be inspected with the `niftypipe_display_crash`
   utility.

#. NiftyPipe determines the hash of the input state of a node. If any input
...
#. Sometimes niftypipe will hang as if nothing is going on and if you hit Ctrl+C
