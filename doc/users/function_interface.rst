...
Most NiftyPipe interfaces provide access to external programs, such as FSL
binaries or SPM routines. However, a special interface,
:class:`niftypipe.interfaces.utility.Function`,
...
yourself as part of your NiftyPipe scripts. Consider the following function::
...
Just as NiftyPipe interfaces have inputs and outputs, Python functions have
...
that the input file came from a different directory::
    ...
    pipeline = pe.Workflow(name='niftypipe_demo')
