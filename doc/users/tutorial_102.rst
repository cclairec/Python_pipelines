...
:class:`niftypipe.pipeline.engine.Workflow`
:class:`niftypipe.pipeline.engine.Node` and
:class:`niftypipe.pipeline.engine.MapNode`.
...
:class:`niftypipe.interfaces.fsl.BET` will operate on only one (3d or 4d)
