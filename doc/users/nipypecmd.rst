...
============================================================
Running NiftyPipe Interfaces from the command line (nipype_cmd)
============================================================

The primary use of NiftyPipe_ is to build automated non-interactive pipelines.
...
command line equivalents (nipy or SPM). Being able to run NiftyPipe interfaces opens new
possibilities such as inclusion of SPM processing steps in bash scripts.

To run NiftyPipe Interafces you need to use the nipype_cmd tool that should already be installed.
