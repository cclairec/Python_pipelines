...
==========================================
Making your own copy (fork) of niftypipe
==========================================

You need to do this only once.  The instructions here are very similar
to the instructions at http://help.github.com/forking/ |emdash| please see
that page for more detail.  We're repeating some of it here just to give the
specifics for the niftypipe_ project, and to suggest some default names.
...
Create your own forked copy of niftypipe_
===========================================

#. Log into your github_ account.
#. Go to the niftypipe_ github home at `niftypipe github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause and some 'Hardcore forking action', you
   should find yourself at the home page for your own forked copy of niftypipe_.
