...
in niftypipe_ .. |emdash| excellent!
...
Then, send the generated patch files to the `niftypipe
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `niftypipe mailing list`_.
...
Fork the niftypipe_ repository on gitlab |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@cmiclab.cs.ucl.ac.uk::your-user-name/CMIC/NiftyPipe.git 
